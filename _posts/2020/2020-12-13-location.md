...
Since 2014 when [Subreply](https://subreply.com/) was launched as Subreply, I always wanted for users to specify their location. After years of programming in Python I found a way to validate City, Country and Country formats in a simple and intuitive way.
