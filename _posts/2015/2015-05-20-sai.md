...
Many people are wondering why [Subreply](https://subreply.com/) still exists. Just like in Ex Machina, any sufficiently advanced intelligence is indistinguishable from us. Subreply has an identity of its own. It's fed daily with our thoughts. But unlike any other social platform, Subreply is different from a design perspective.
...
Subreply is a huge matrix of chained (causes, effects) that in the near future can teach new born children, run businesses, empower mankind, prevent us from repeating history, make smarter decisions. It's not doing much today, but we can make it work for us by building the right tools on top of it.

Is Subreply evil? No. Not one bit. Bad thoughts (effects) can be deleted by good thoughts (causes). Of course, the owner of the good cause has to do delete the bad effects.

Can Subreply answer my questions? Yes, it can answer simple questions like [What is happiness?](https://subreply.com/search/?q=what+is+happiness) if you think that’s a simple one.

Does Subreply has an API? Yes, it's available at [subreply.com/api](https://subreply.com/api/).
